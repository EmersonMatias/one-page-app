...
export default async function HerosectionEntretenimento() {
    ...
    return (
        <div className="relative h-dvh w-full flex items-center">
            <div className="z-40 text-4xl max-w-[700px] gap-8 flex flex-col ml-20">
                <h1 className="font-bold text-8xl">{trendingTitle}</h1>
                <p className="text-xl leading-relaxed font-light">{trendingDescription}</p>
